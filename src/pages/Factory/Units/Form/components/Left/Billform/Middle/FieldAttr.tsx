        ...
        <Tabs defaultActiveKey={'base'}>
          <TabPane key={'base'} tab={'基础'} tabKey={'base'}>
            ...
            >
              ...
              <Col span={16}>
                <Form.Item label={''} name={'width'} noStyle={true}>
                  {activeItem === 'width' ? (
                    <InputNumber autoFocus onBlur={hanleToggleInput('')} />
                  ) : (
                    <Row
            ...
            >
              ...
              <Col span={16}>
                <Form.Item label={''} name={'placeholder'} noStyle={true}>
                  {activeItem === 'placeholder' ? (
                    ...
                    <Row
                      onClick={hanleToggleInput('placeholder')}
                      style={{ cursor: 'pointer', height: '16px' }}
                    >
                      <Col span={24}>{billFormField?.placeholder}</Col>
                    </Row>
                  )}
                </Form.Item>
              </Col>
              ...
              <Col span={16}>
                <Form.Item label={''} name={'showOrder'} noStyle={true}>
                  {activeItem === 'showOrder' ? (
                    <Input min={0} autoFocus onBlur={hanleToggleInput('')} />
                  ) : (
                    <Row
